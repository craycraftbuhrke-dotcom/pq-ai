...
export const domainPortalCards: readonly DomainPortalCard[] = [
  {
    ...
    href: "/process",
    title: "工艺管理",
    description: "维护喷涂程序与刷子参数，查看生产实绩，并完成预测诊断、推荐试验与工艺变更。",
    icon: "program",
    links: [
      { href: "/process?tab=overview", label: "工艺概况" },
      { href: "/process?tab=recipes", label: "程序与刷子参数" },
      { href: "/process?tab=runs", label: "生产实际参数" },
      { href: "/process?tab=predictions", label: "质量预测与原因排查" },
      { href: "/process?tab=recommendations", label: "参数建议与现场试验" },
      { href: "/process?tab=changes", label: "问题处理与工艺变更" },
    ],
  },
  {
    key: "materials",
  ...
  },
  {
    ...
    href: "/master-data",
    title: "基础资料",
    description: "维护工厂、车型、颜色、零件和机器人信息；测量点在车身点位图维护。",
    icon: "master",
    roles: ["ADMIN", "PROCESS_ENGINEER", "QUALITY_ENGINEER", "INTEGRATION_OPERATOR"],
    links: [
      { href: "/master-data?tab=entities", label: "工厂、车型与颜色" },
      { href: "/quality?tab=body-map", label: "车身点位图维护测量点" },
  ...
  },
  {
    ...
    href: "/ai",
    title: "智能分析",
    description: "模型训练、验收与对比；现场预测与推荐请到工艺管理。",
    icon: "ai",
    roles: ["DATA_SCIENTIST", "PROCESS_ENGINEER", "QUALITY_ENGINEER", "APPROVER", "ADMIN"],
    links: [
      { href: "/ai?tab=models", label: "训练与验收" },
      { href: "/ai?tab=comparison", label: "模型对比" },
      { href: "/process?tab=predictions", label: "质量预测与原因排查" },
    ],
  },
  {
