...
export function ProductionWorkspace() {
  ...
  function remove(kind: ModalKind, _id: string) {
    void _id;
    ...
    setNotice("");
    setError(`${labels[kind]}不能物理删除。${physicalDeleteDisabledMessage}`);
  }
